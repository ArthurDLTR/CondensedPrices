...
/**
 *	\file       condensedprices/condensedpricesindex.php
...
//}
//if (! $user->hasRight('condensedprices', 'myobject', 'read')) {
//	accessforbidden();
//}
//restrictedArea($user, 'condensedprices', 0, 'condensedprices_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
// Draft MyObject
if (isModEnabled('condensedprices') && $user->hasRight('condensedprices', 'read')) {
	$langs->load("orders");
...
if (isModEnabled('condensedprices') && $user->hasRight('condensedprices', 'read')) {
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."condensedprices_myobject as s";
